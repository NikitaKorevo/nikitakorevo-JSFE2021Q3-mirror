/* 138 строчка html
<!-- TODO: удалить 2 кнопки на Stage 1 -->
          <!-- <button class="video__buttonPrev">&lt;</button>
          <button class="video__buttonNext">&gt;</button> -->
 */

console.log(`
Last UPD2: +14 баллов в пункте "Валидация формы"
UPD1: +10 баллов в пункте "Слайдер в секции Video", +2 балла в секции "Калькулятор продажи билетов в форме продажи билетов"
Score: 146 / 160
...
[+] Кнопка, которая пролистывает страницу вверх +10
`)